...
/* Данные для протокола Шамира */
define(p,43613);
define(msg,'TAN');

class Shamir_protocol extends My_math
{
	...
	public function encrypt()
	{
		...
		$C_1 = $this->getC($ASCII_msg, $key_A['e_a'],p);
		...
		$msg_ASCII = $this->getC($C_3, $key_B['d_b'],p);
